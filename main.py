...
def get_font(size):  # Возвращает шрифт в заданном размере
    return pygame.font.Font("data/Mono_cyr.ttf", size)


# Загружаем музыку
pygame.mixer.music.load(os.path.join('data', 'Hecu.mp3'))
pygame.mixer.music.play(-1)
postal = pygame.mixer.Sound(os.path.join('data', 'Postal.mp3'))

# Загружаем изображения
space_ship_shooting = pygame.image.load(os.path.join('data', 'enemyBlack1.png'))
suicide_ship = pygame.image.load(os.path.join('data', 'sprite_ship_3.png'))
# mother_ship = pygame.image.load(os.path.join('Игоря на pygame assets', 'playerShip1_red.png'))

# Корабль игрока
player_space_ship = pygame.image.load(os.path.join('data', 'playerShip1_red.png'))
damage = pygame.image.load(os.path.join('data', 'damage.png'))

# Пули
player_bullet = pygame.image.load(os.path.join('data', 'laserRed01.png'))
enemy_bullet = pygame.image.load(os.path.join('data', 'laserBlue01.png'))

# Аптечка
medkit = pygame.image.load(os.path.join('data', 'pill_blue.png'))

# Задний фон
bg = pygame.image.load(os.path.join('data', 'black.png'))
...
def play():
    ...
    while running:
        ...
        while jameover:
            ...
            keys = pygame.key.get_pressed()
            if keys[K_l]:
                pygame.mixer.music.load(os.path.join('data', 'Ratz.mp3'))
                pygame.mixer.music.play(-1)
